{{ config(unique_key='business_key||insert_ts') }}
/*
Wir benutzen hier einen konkatenierten Key aus key und insert_ts (hat etwas von einem Data Vault Satelliten ohne den surrogate key)
...
und das insert_ts zuverlässig größer wird.
